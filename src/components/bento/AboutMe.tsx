      ...
      <div className="p-4 border-t border-border bg-card-bg/50">
        <div className="flex items-center justify-center gap-2">
          ...
          <button
            ...
            aria-label="GitHub"
          >
            <svg className="size-4 text-warm-gold" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            aria-label="Email"
          >
            <svg className="size-4 text-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor">
